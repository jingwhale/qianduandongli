<?php
/*
 * Install Uninstall Upgrade AutoStat System Code 2015030317oFgQjJPi64
...
if(str_replace('X', '', DISCUZ_VERSION) >= 3.1){
		$_GET['step'] = 'sql';
		$_GET['deletesql'] = '2015030317oFgQjJPi64';
}
if($_GET['available']){
...
//		runquery($sql);
	...
	case 'stat':
		...
		$_statInfo['SiteUrl'] = 'http://localhost/discuz/';
		$_statInfo['ClientUrl'] = 'http://localhost/discuz/';
		$_statInfo['SiteID'] = '5410E6A6-8E98-B93A-442F-7FB4E3B75638';
